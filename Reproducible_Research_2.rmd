...
# Convert Property Damage Magnitude to factors, and check out the levels in this variable.
...
dataset[PROPDMGEXP %like% 'M|m', PropertyDamage := PROPDMG * 1000000]
dataset[PROPDMGEXP == 'B', PropertyDamage := PROPDMG * 1000000000]
...
dataset[CROPDMGEXP %like% 'M|m', CropDamage := CROPDMG * 1000000]
dataset[CROPDMGEXP == 'B', CropDamage := CROPDMG * 1000000000]
