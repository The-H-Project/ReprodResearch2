...
There are 977 different 'event types'. However, many of the 'event types' describe the same type of event, and only vary because of spelling, punctuation, and word order. For example, there are 

```{r evtype_field}
length(unique(dataset$EVTYPE))
head(unique(dataset$EVTYPE),20)
